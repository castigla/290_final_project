...
$stmt = $conn->prepare("SELECT fname, lname FROM characters join character_school on characters.id = character_school.cid join school on character_school.sid = school.id where name = ?");
